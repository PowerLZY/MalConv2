...
parser.add_argument('--mal_train', type=dir_path, default="data/mal_train", help='Path to directory containing malware files for training')
parser.add_argument('--ben_train', type=dir_path, default="data/ben_train", help='Path to directory containing benign files for training')
parser.add_argument('--mal_test', type=dir_path, default="data/mal_test", help='Path to directory containing malware files for testing')
parser.add_argument('--ben_test', type=dir_path, default="data/ben_test", help='Path to directory containing benign files for testing')
